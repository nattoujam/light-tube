...
from core.platform.platform_a import PlatformA
from core.platform.platform_b import PlatformB
from core.repository import Repository
from app.models import Video

def test_platform_a_fetch_videos():
    api_key = "test_key"
    platform = PlatformA(api_key)
